    ...
    return (
        <div className='mt-16 flex flex-col items-center gap-3'>
            ...
            <div className='flex gap-4 mt-2 text-3xl justify-center'>
                <button className='hover:text-accent' onClick={() => handleEmailClick()}><BsEnvelope /></button>
                <a className='hover:text-accent' href="https://www.linkedin.com/in/mikulas-stec/" target='_blank' ><PiLinkedinLogo /></a>
                <button className='hover:text-accent' onClick={handleWhatsAppClick}><PiWhatsappLogo /></button>
            </div>
        </div>
    )
}
